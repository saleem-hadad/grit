                        ...
                        <div className='bg-slate-50 rounded p-4'>
                            ...
                            <div className='space-y-2'>
                                {competency.metrics.map((metric) => (
                                    <div className={metric.achievements.length > 0 ? 'border border-dashed bg-slate-100 rounded p-2' : 'border border-dashed bg-red-50 rounded p-2'}>
                                            ...
                                            {metric.achievements.map((achievement) => (
                                                <li className='pl-4 relative'>
                                                    ...
                                                    <div className='flex justify-between'>
                                                        <p key={achievement.id} className="z-10 text-gray-500 px-2">{achievement.summary} - {achievement.date}</p>
                                                        <div className='flex z-10'>
                                                        {achievement.links.map((link) => (<AutoIconLink key={link.url} url={link.url} label={link.label} />))}
                                                        </div>
                                                    </div>
                                                </li>
                                            ))}
